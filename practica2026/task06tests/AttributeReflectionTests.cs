...
namespace task06tests
{
    public class AttributeReflectionTests
    {
        ...
        public void Class_HasDisplayNameAttribute()
        {
            ...
            var attribute = type.GetCustomAttribute<task06.DisplayNameAttribute>();
        ...
        public void Method_HasDisplayNameAttribute()
        {
            ...
            var attribute = method.GetCustomAttribute<task06.DisplayNameAttribute>();
            Assert.NotNull(attribute);
        ...
        public void Property_HasDisplayNameAttribute()
        {
            ...
            var attribute = prop.GetCustomAttribute<task06.DisplayNameAttribute>();
            Assert.NotNull(attribute);
